...
## Olá, eu sou o Raniere

Desenvolvo aplicações, integrações, automações e soluções de dados para transformar problemas reais de negócio em ferramentas úteis no dia a dia.

Meu trabalho acontece na interseção entre **software**, **automação** e **dados** — da ideia à entrega, sem perder de vista quem vai usar e o resultado que precisa aparecer.
...
| Software | Automação | Dados & BI |
| :--- | :--- | :--- |
| Aplicações web, mobile e desktop | Integrações, webhooks e rotinas | ETL/ELT, modelagem e qualidade |
| APIs e sistemas internos | Processos de back-office | Dashboards, indicadores e análise |
| Produtos digitais sob medida | Fluxos entre ERP, CRM e outros serviços | Informação pronta para decisão |
